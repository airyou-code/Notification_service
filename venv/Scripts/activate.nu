...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\KODER\Django_prk\Notification_service\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\KODER\Django_prk\Notification_service\venv\Scripts\deactivate.nu'
